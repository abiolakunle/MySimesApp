...
import com.software.abiol.simesapp.activities.ChatActivityLoadAll;
import com.software.abiol.simesapp.activities.UsersActivity;
import com.software.abiol.simesapp.models.Conv;
...
public class ChatsFragment extends Fragment {
    ...
    private FloatingActionButton newChatFloat;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        newChatFloat = mMainView.findViewById(R.id.chat_add_float);
        ...
        newChatFloat.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        convViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent chatIntent = new Intent(getContext(), ChatActivityLoadAll.class);

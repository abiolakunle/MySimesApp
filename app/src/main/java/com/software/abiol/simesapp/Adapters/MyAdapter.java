...
import com.software.abiol.simesapp.StateVO;
        ...
        holder.mCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (!isFromView) {
                    ...
                    Intent intent = new Intent(mContext.getApplicationContext(), UploadToLibraryActivity.class);
                    intent.putExtra("checkbox_state", listState);

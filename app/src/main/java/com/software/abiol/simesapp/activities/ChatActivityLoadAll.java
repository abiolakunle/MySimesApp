...
import com.software.abiol.simesapp.Adapters.MessageAdapter;
...
public class ChatActivityLoadAll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chat_load_all);
        ...
        mRootRef.child("Users").child(mChatUser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Glide.with(ChatActivityLoadAll.this).load(image).into(mProfileImage);
